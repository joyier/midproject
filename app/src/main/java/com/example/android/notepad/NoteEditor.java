...
public class NoteEditor extends Activity {
    ...
    private String mediaUri = null; // 存储多媒体文件路径
    private String noteType = "text"; // 默认类型为文字
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnAddImage = (Button) findViewById(R.id.btn_add_image);

        Button btnAddVideo = (Button) findViewById(R.id.btn_add_video);

        btnAddImage.setOnClickListener(view -> pickImage());
    
        btnAddVideo.setOnClickListener(view -> recordVideo());
        /*
        ...
        int columnIndex = mCursor.getColumnIndex(NotePad.Notes.COLUMN_NAME_MEDIA_URI);
        if (columnIndex == -1) {
            Log.e("NotePad", "Column COLUMN_NAME_MEDIA_URI not found in database");
        } else {
            String mediaUri = mCursor.getString(columnIndex);
            if (mediaUri != null && !mediaUri.isEmpty()) {
                imagePreview.setVisibility(View.VISIBLE);
                imagePreview.setImageURI(Uri.parse(mediaUri));
            } else {
...
//END_INCLUDE(paste)
    ...
    private final void updateNote(String text, String title) {
        ...
        values.put(NotePad.Notes.COLUMN_NAME_TYPE, noteType);
        values.put(NotePad.Notes.COLUMN_NAME_MEDIA_URI, mediaUri);
